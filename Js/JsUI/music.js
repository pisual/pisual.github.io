 ...
 // $('#LightBox').prepend('');
  $('#body').prepend('<div id="grid-gallery" class="grid-gallery">' +
     ...
     '<li>' +
      ...
      '<p>喵小姐近日突然觉悟，想要锻炼身体增强身体免疫力，正在想哪种方法的时候，发现自己的室内小略子运动车自从买来就没用过，便准备用室内小略子运动车锻炼，室内小略子运动车是一个三条腿的座地的运动设备，使用的时候需要坐在上边，使劲用脚蹬下面的踏板，然后车就发出DFM！DPM！这样的声音，如果想要加大阻力，使用者需要喊出”FM“的口令，就会自动加大阻力，如果喊出“PM”，就会减小阻力，使用起来非常简单，喵小姐第一次使用，力气比较小，都不用加阻力就累的气喘吁吁的，在喵小姐休息的时候，熊小喵先生跨上小略子运动车，等起来感觉没什么力气，就准备加大阻力，喊起来“FM！FM！”，因为每一次加的的阻力比较小，都不断的喊，喵小姐听到，愤怒的跳到熊猫先哼身上一顿狂药，头发咬掉了，熊猫先哼心中疑惑，难道是加阻力喵小姐比较不爽，那就减小一点阻力吧，便又大声喊起来“PM！PM！”，喵小姐听到更生气了，直接咬到熊猫先生的肚脐上不下来，熊猫先生痛的脚都变小了。（乖乖养病，注意保暖，做健康大喵子，我会全力支持喵小姐的锻炼行动的）</p>' +
      '</figcaption>' +
      '<img src="Images/a3.jpg" alt="img04"/>' +
      '</figure>' +
      '</li>' +	  	
