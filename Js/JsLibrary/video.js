(function() {
    ...
    t.d = function(a, c, d) {
        ...
        e.X || (e.disabled = l, e.X = function(c) {
            if (!e.disabled) {
                c = t.qc(c);
                var d = e.C[c.type];
                if (d) for (var d = d.slice(0), k = 0, n = d.length; k < n && !c.yc(); k++) d[k].call(a, c)
            }
        });
    ...
    t.get = function(a, c, d, e) {
        ...
        k = t.Ud(a);
        n = window.location;
        k.protocol + k.host !== n.protocol + n.host && window.XDomainRequest && !("withCredentials" in h) ? (h = new window.XDomainRequest, h.onload = function() {
            c(h.responseText)
        },
    ...
    t.hc.forEach = function(a, c, d) {
        if (t.g.isArray(a) && c instanceof Function) for (var e = 0,
    ...
    s.vc = function() {
        var a, c, d, e;
        a = this;
        if (c = this.options().children) if (t.g.isArray(c)) for (var g = 0; g < c.length; g++) d = c[g],
    ...
    t.Player = t.a.extend({
        i: function(a, c, d) {
            ...
            this.d("mousemove",
            function(a) {
                if (a.screenX != n || a.screenY != r) n = a.screenX,
                r = a.screenY,
                e()
            });
            this.d("mouseup",
    ...
    function da(a) {
        ...
        if (a.hasChildNodes()) {
            ...
            "source" === d ? e.sources.push(t.za(c)) : "track" === d && e.tracks.push(t.za(c))
        }
        return e
    }
    s.e = function() {
    ...
    function S(a, c) {
        if (a.n && a.n.la) try {
            ...
            throw a.n[c] === b ? t.log("Video.js: " + c + " method not defined for " + a.eb + " playback technology.", d) : "TypeError" == d.name ? (t.log("Video.js: " + c + " unavailable on " + a.eb + " playback technology element.", d), a.n.la = l) : t.log(d),
            d;
        }
    }
    s.play = function() {
    ...
    s.duration = function(a) {
        if (a !== b) return this.G.duration = parseFloat(a),
        this;
    ...
    function U(a, c) {
        ...
        e;
        d ? d.n === a.eb ? a.src(d.source) : Q(a, d.n, d.source) : (e = setTimeout(t.bind(a,
        function() {
            this.error({
                code: 4,
    ...
    s.userActive = function(a) {
        return a !== b ? (a = !!a, a !== this.Rb && ((this.Rb = a) ? (this.pa = f, this.p("vjs-user-inactive"), this.m("vjs-user-active"), this.k("useractive")) : (this.pa = l, this.n && this.n.Q("mousemove",
        function(a) {
            a.stopPropagation();
            a.preventDefault()
    ...
    t.lb.prototype.update = function() {
        ...
        d = g.end(a),
        (e = k[a]) || (e = this.b.appendChild(t.e())),
    ...
    s.wa = function() {
        ...
        if (c) for (var d = c.length - 1; 0 <= d; d--) a.S(new t.nb(this.j(), {
            rate: c[d] + "x"
        }));
        return a
    };
    ...
    t.q = t.a.extend({
        i: function(a, c, d) {
            ...
            c.Ic = l;
            t.a.call(this, a, c, d);
            this.featuresProgressEvents || (this.Ac = f, this.Fc = setInterval(t.bind(this,
            function() {
            ...
            this.featuresTimeupdateEvents || (this.Kb = f, this.j().d("play", t.bind(this, this.Qc)), this.j().d("pause", t.bind(this, this.cb)), this.Q("timeupdate",
            function() {
    ...
    s.Qc = function() {
        this.lc && this.cb();
        this.lc = setInterval(t.bind(this,
        function() {
            this.j().k("timeupdate")
        }), 250)
    };
    ...
    s.oc = function() {
        var a = this.b;
        "webkitDisplayingFullscreen" in a && this.Q("webkitbeginfullscreen", t.bind(this,
        function() {
            this.c.isFullscreen(f);
            this.Q("webkitendfullscreen", t.bind(this,
            function() {
    ...
    t.f = t.q.extend({
        i: function(a, c, d) {
            ...
            c.attributes);
            e && (e.type && t.f.Dd(e.type) ? (e = t.f.Oc(e.src), k.rtmpConnection = encodeURIComponent(e.wb), k.rtmpStream = encodeURIComponent(e.Qb)) : k.src = encodeURIComponent(t.sc(e.src)));
            t.Gb(g, d);
    ...
    function Y(a, c, d) {
        ...
        h = e.length,
        k, n; g < h; g++) k = e[g],
        k.id() === c ? (k.show(), n = k) : d && (k.K() == d && 0 < k.mode()) && k.disable(); (c = n ? n.K() : d ? d: l) && a.k(c + "trackchange")
    }
    t.B = t.a.extend({
        i: function(a, c) {
            t.a.call(this, a, c);
    ...
    s.Td = function(a) {
        ...
        for (var e = "",
        g = 1,
        h = a.length; g < h; g++) if (e = t.trim(a[g])) { - 1 == e.indexOf("--\x3e") ? (c = e, e = t.trim(a[++g])) : c = this.ca.length;
            c = {
                id: c,
    ...
    s.update = function() {
        if (0 < this.ca.length) {
            ...
            if (this.Ob === b || a < this.Ob || this.Wa <= a) {
                ...
                for (;;) {
                    r = c[w];
                    if (r.xa <= a) e = Math.max(e, r.xa),
                    r.Na && (r.Na = l);
                    else if (a < r.startTime) {
                        if (d = Math.min(d, r.startTime), r.Na && (r.Na = l), !g) break
                    } else g ? (h.splice(0, 0, r), n === b && (n = w), k = w) : (h.push(r), k === b && (k = w), n = w),
                    d = Math.min(d, r.xa),
                    e = Math.max(e, r.startTime),
                    r.Na = f;
                    if (g) if (0 === w) break;
                    else w--;
    ...
    s.wa = function() {
        for (var a = this.c.textTracks(), c = 0, d = a.length, e, g, h = this.P = []; c < d; c++) if (e = a[c], e.K() == this.H) if (0 === e.readyState()) e.load(),
    ...
    "complete" === document.readyState ? t.Tc = f: t.Q(window, "load",
    function() {
        t.Tc = f
    });
    t.ub();
